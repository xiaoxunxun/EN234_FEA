!     Subroutines for basic B bar elements



!==========================SUBROUTINE B Bar Elements ==============================
subroutine B_bar_3D(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
  ...
  ! real (prec) :: dNbardx (27,3)
    ...
    do kint = 1, n_points
        ...
        dNbardx(1:n_nodes,1:3) = (1/el_vol)*dNdx*w(kint)*determinant
        Bbard = 0.d0
        Bbard(1,1:3) = dNbardx(1,1:3)-dNdx(1,1:3)
        Bbard(1,4:6) = dNbardx(2,1:3)-dNdx(2,1:3)
        Bbard(1,7:9) = dNbardx(3,1:3)-dNdx(3,1:3)
        Bbard(1,10:12) = dNbardx(4,1:3)-dNdx(4,1:3)
        Bbard(1,13:15) = dNbardx(5,1:3)-dNdx(5,1:3)
        Bbard(1,16:18) = dNbardx(6,1:3)-dNdx(6,1:3)
        Bbard(1,19:21) = dNbardx(7,1:3)-dNdx(7,1:3)
        Bbard(1,22:24) = dNbardx(8,1:3)-dNdx(8,1:3)
        Bbard(1,25:27) = dNbardx(9,1:3)-dNdx(9,1:3)

        Bbard(2,1:3) = dNbardx(1,1:3)-dNdx(1,1:3)
        Bbard(2,4:6) = dNbardx(2,1:3)-dNdx(2,1:3)
        Bbard(2,7:9) = dNbardx(3,1:3)-dNdx(3,1:3)
        Bbard(2,10:12) = dNbardx(4,1:3)-dNdx(4,1:3)
        Bbard(2,13:15) = dNbardx(5,1:3)-dNdx(5,1:3)
        Bbard(2,16:18) = dNbardx(6,1:3)-dNdx(6,1:3)
        Bbard(2,19:21) = dNbardx(7,1:3)-dNdx(7,1:3)
        Bbard(2,22:24) = dNbardx(8,1:3)-dNdx(8,1:3)
        Bbard(2,25:27) = dNbardx(9,1:3)-dNdx(9,1:3)

        Bbard(3,1:3) = dNbardx(1,1:3)-dNdx(1,1:3)
        Bbard(3,4:6) = dNbardx(2,1:3)-dNdx(2,1:3)
        Bbard(3,7:9) = dNbardx(3,1:3)-dNdx(3,1:3)
        Bbard(3,10:12) = dNbardx(4,1:3)-dNdx(4,1:3)
        Bbard(3,13:15) = dNbardx(5,1:3)-dNdx(5,1:3)
        Bbard(3,16:18) = dNbardx(6,1:3)-dNdx(6,1:3)
        Bbard(3,19:21) = dNbardx(7,1:3)-dNdx(7,1:3)
        Bbard(3,22:24) = dNbardx(8,1:3)-dNdx(8,1:3)
        Bbard(3,25:27) = dNbardx(9,1:3)-dNdx(9,1:3)
    ...
    return
end subroutine B_bar_3D




!==========================SUBROUTINE fieldvars_linelast_3dbasic ==============================
subroutine fieldvars_linelast_Bbar_3D(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    n_properties, element_properties,element_coords,length_coord_array, &                                ! Input variables
    dof_increment, dof_total, length_dof_array,  &                                                      ! Input variables
    ...
    return
end subroutine fieldvars_linelast_Bbar_3D
